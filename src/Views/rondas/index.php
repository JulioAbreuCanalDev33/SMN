...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0">
            <i class="bi bi-shield-check me-2 text-primary"></i>Rondas Periódicas
        </h1>
        <p class="text-muted mb-0">Gerenciar rondas de segurança</p>
    </div>
    <a href="<?php echo BASE_URL; ?>rondas/criar" class="btn btn-primary">
        <i class="bi bi-plus-lg me-1"></i>Nova Ronda
    </a>
</div>
